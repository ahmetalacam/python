...
Button(root, text=">", width=5, height=2, font=("arial", 13, "bold"), fg="black", bg="gold", command=play_song).place(x=300, y=500)
Button(root, text="<", width=5, height=2, font=("arial", 13, "bold"), fg="black", bg="gold", command=play_song).place(x=50, y=500)
