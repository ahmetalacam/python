...
Button(root,image=next_button,bg="white",bd=0, command=play_song).place(x=10 ,y=470)

previous_button = PhotoImage(file="left.png")
Button(root,image=previous_button,bg="white",bd=0, command=play_song).place(x=110 ,y=470)
...
Button(root,image=repeat_button,bg="black",bd=0, command=play_song).place(x=410 ,y=470)
