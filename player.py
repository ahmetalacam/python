...
def play_song():    
    animation()
    music_name = songlist.get(ACTIVE)
    mixer.music.load(songlist.get(ACTIVE))
    mixer.music.play()   
...
keyboard.add_hotkey('8', play_previous_song)
...
Button(root, text=">", width=5, height=2, font=("arial", 13, "bold"), fg="black", bg="gold", bd=4, command=play_song).place(x=300, y=300)
Button(root, text="<", width=5, height=2, font=("arial", 13, "bold"), fg="black", bg="gold", bd=4, command=play_song).place(x=60, y=300)
